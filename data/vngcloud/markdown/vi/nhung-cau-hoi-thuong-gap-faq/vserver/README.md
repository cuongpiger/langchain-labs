...
Quý khách có thể thực hiện như sau : Thực hiện extend disk trên portal VNG Cloud:[ Mở rộng Volume với hệ điều hành Linux](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/volume/mo-rong-volume-voi-he-dieu-hanh-linux).

### \[vServer]Làm sao để extend disk trong Window ?

 [Mở rộng Volume với hệ điều hành Window](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/volume/mo-rong-volume-voi-he-dieu-hanh-window) Quý khách có thể thực hiện như sau :[ Thực hiện extend disk trên portal VNG Cloud](https://docs.vngcloud.vn/vng-cloud-document/vn/nhung-cau-hoi-thuong-gap-faq/vserver#vserver-lam-sao-de-extend-disk-trong-window)
...
Bạn có thể vào phần Storage trên Portal để add thêm Volume tối đa lên tới 10TB cho Server của mình theo hướng dẫn tại trang [Tăng kích thước Volume](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/volume).
...
Bạn vui lòng vào Group Default add lại các rule Ingress và Egress default theo như [hướng dẫn sau](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/security/ssh-key-bo-khoa) giúp để có thể ssh vào lại server.
