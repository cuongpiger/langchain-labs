...
* [A - Khởi tạo Configuration Group](https://docs.vngcloud.vn/vng-cloud-document/vn/vdb/memorystore-database-service-mds/quan-ly-cau-hinh-mds-instance#quanlycauhinhmdsinstance-a-khoitaoconfigurationgroup)
* [B - Chỉnh sửa các biến cấu hình](https://docs.vngcloud.vn/vng-cloud-document/vn/vdb/memorystore-database-service-mds/quan-ly-cau-hinh-mds-instance#quanlycauhinhmdsinstance-b-chinhsuacacbiencauhinh)
* [C - Liên kết MDS Instance với Configuration Groups](https://docs.vngcloud.vn/vng-cloud-document/vn/vdb/memorystore-database-service-mds/quan-ly-cau-hinh-mds-instance#quanlycauhinhmdsinstance-c-lienketmdsinstancevoiconfigurationgroups)
* [D - Xóa Configuration Group](https://docs.vngcloud.vn/vng-cloud-document/vn/vdb/memorystore-database-service-mds/quan-ly-cau-hinh-mds-instance#quanlycauhinhmdsinstance-a-khoitaoconfigurationgroup-1)
...
### C - Liên kết MDS Instance với Configuration Groups 
