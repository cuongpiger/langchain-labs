...
* [A. Sao lưu theo nhu cầu (On-demand backup hay Manual backup)](https://docs.vngcloud.vn/vng-cloud-document/vn/vdb/memorystore-database-service-mds/sao-luu-mds-instance#saoluumdsinstance-a.saoluutheonhucau-on-demandbackuphaymanualbackup)
* [B. Sao lưu tự động theo ngày (Auto-Daily Backup)](https://docs.vngcloud.vn/vng-cloud-document/vn/vdb/memorystore-database-service-mds/sao-luu-mds-instance#saoluumdsinstance-b.saoluutudongtheongay-auto-dailybackup)
* [C. Khôi phục MDS Instance từ bản Backup](https://docs.vngcloud.vn/vng-cloud-document/vn/vdb/memorystore-database-service-mds/sao-luu-mds-instance#saoluumdsinstance-a.saoluutheonhucau-on-demandbackuphaymanualbackup-1)
* [D. Xóa bản Backup](https://docs.vngcloud.vn/vng-cloud-document/vn/vdb/memorystore-database-service-mds/sao-luu-mds-instance#saoluumdsinstance-a.saoluutheonhucau-on-demandbackuphaymanualbackup-2)
...
* Cách 1: Cấu hình luôn trong lúc khởi tạo DB Instance. Đối với phương án đầu, mời bạn xem lại hướng dẫn Khởi tạo DB Instance tại [Hướng dẫn khởi tạo MDS Instance](https://docs.vngcloud.vn/vng-cloud-document/vn/vdb/memorystore-database-service-mds/khoi-tao-mds-instance).
* Cách 2: Thay đổi tại giao diện quản lý Database.
  *   Bạn truy cập màn hình quản lý Database, click chọn DB Instance muốn cấu hình. Sau đó, bạn click chọn **Edit DB Setting**. 
      ...
      ![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1).png?raw=true)
...
### C. Khôi phục MDS Instance từ bản Backup 
...
*   Nhấn chọn vào bản Backup mà bạn muốn khôi phục, chọn Action **Restore**. Quá trình Restore cũng gần tương tự như quá trình Tạo một MDS Instance mới. 
    ...
    ![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1).png?raw=true)
