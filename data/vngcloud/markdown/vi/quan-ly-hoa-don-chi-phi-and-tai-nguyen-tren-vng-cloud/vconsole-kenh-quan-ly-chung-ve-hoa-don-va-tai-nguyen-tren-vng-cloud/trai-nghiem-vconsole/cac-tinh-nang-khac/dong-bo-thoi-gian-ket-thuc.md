...
1. **Đăng nhập vào tài khoản:**
   ...
   * Làm theo hướng dẫn sau để đăng nhập vào tài khoản VNG Cloud [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/identity-and-access-management-iam/cac-loai-dinh-danh-iam/tai-khoan-user-accounts/cach-dang-nhap-vao-vng-cloud).
...
3. **Chọn các tài nguyên cần điều chỉnh:**
   ...
   *   **Bước 3: Nhấn chọn hành động Match end time / Đồng bộ thời gian kết thúc** 
       ...
       ![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(21)%20(1)%20(1).png?raw=true)
4. **Thiết lập ngày kết thúc mới:**
   ...
   *   Bước 3: Nhấn Match end time / Đồng bộ gia hạn để xác nhận thực hiện gia hạn
       ...
       ![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1).png?raw=true)
5. **Thực hiện thanh toán tại trang thanh toán để hoàn tất quá trình:**

![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(2)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1)%20(1).png?raw=true)
