...
#### 1. Chính sách tự động gia hạn tài nguyên chỉ áp dụng đối với: 
...
#### **2. Hướng dẫn bật/tắt tính năng "Tự động gia hạn"** 
...
*   **Bật "Tự động gia hạn" khi khởi tạo**
    ...
    * Bước 2: Tại trang thanh toán, tick vào "**Auto-renew**" để bật tính năng tự động gia hạn
    ...
    ![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(919).png?raw=true)
...
![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(920).png?raw=true)
...
![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(921).png?raw=true)
...
#### **3. Quy trình tự động gia hạn tài nguyên** 
