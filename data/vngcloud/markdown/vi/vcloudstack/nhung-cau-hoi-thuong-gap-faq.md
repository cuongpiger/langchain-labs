...
### **\[vCloudStack] Những tài nguyên vật lý của doanh nghiệp sẽ đặt ở đâu?**
...
### **\[vCloudStack] Những doanh nghiệp nào phù hợp sử dụng dịch vụ vCloudStack của VNG Cloud?**
...
### **\[vCloudStack] Khi một host vật lý bị sự cố thì dịch vụ vCloudStack xử lý thế nào?**

...

### **\[vCloudStack] Việc sử dụng ảo hóa các tài nguyên vật lý sẽ có tỷ lệ ratio như thế nào?**
...
### **\[vCloudStack] Làm thế nào để theo dõi lịch sử hoạt động của máy ảo?**
...
### **\[vCloudStack] Làm thế nào để theo dõi lịch sử hoạt động của host vật lý?**

...

### **\[vCloudStack] Có thể tùy chọn ngưỡng vận hành provisioning của tài nguyên được không? Nhưng nếu để ngưỡng quá cao thì ảnh hưởng gì hay không?**
...
### **\[vCloudStack] Để tránh những rủi ro khi vận hành, có thể tạo máy chủ VM ở những host khác nhau không?**
