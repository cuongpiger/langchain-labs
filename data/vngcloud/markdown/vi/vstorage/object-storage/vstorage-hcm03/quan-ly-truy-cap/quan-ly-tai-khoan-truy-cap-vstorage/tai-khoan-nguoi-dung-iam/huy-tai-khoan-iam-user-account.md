...
Kể từ thời điểm IAM User Account bị hủy thành công, bạn sẽ không thể sử dụng IAM User Account này để truy xuất vào vStorage. Hãy thận trọng khi thực hiện thao tác hủy (xóa) tài khoản IAM User Account bởi bạn sẽ không thể khôi phục tài khoản đã xóa này. Chi tiết hãy tham khảo thêm tại [đây.](https://docs.vngcloud.vn/vng-cloud-document/vn/identity-and-access-management-iam)
