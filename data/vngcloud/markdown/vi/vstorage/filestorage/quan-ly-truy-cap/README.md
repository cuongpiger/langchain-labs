...
![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(6)%20(4).png?raw=true)
...
7. Chọn **Actions**:
   ...
   2. Chọn **All file storage actions** nếu muốn tạo policy có quyền thực hiện tất cả các hành động trên File Storage. Chi tiết ý nghĩa của các action vui lòng tham khảo tại [Tính năng, tài nguyên File Storage và quyền truy cập](https://docs.vngcloud.vn/vng-cloud-document/vn/vstorage/filestorage/quan-ly-truy-cap/tinh-nang-tai-nguyen-file-storage-va-quyen-truy-cap)
8. Chọn **Resources**:
...
![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(7)%20(4).png?raw=true)
