...
![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(299).png?raw=true)

***

### Các bước thực hiện

![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(307).png?raw=true)

Cụ thể: 

* **Bước 1:** Chuẩn bị cluster đích (Prepard target resource): trên hệ thống VKS, bạn cần thực hiện khởi tạo một Cluster theo hướng dẫn tại [đây](https://docs.vngcloud.vn/vng-cloud-document/vn/vks/clusters). Đảm bảo rằng cấu hình của cluster đích giống với cấu hình của cluster nguồn.
...
* [Migrate Cluster from VKS to VKS](https://docs.vngcloud.vn/vng-cloud-document/vn/vks/migration/migrate-cluster-from-vks-to-vks)
* [Migrate Cluster from vContainer to VKS](https://docs.vngcloud.vn/vng-cloud-document/vn/vks/migration/migration-cluster-from-vcontainer-to-vks)
* [Migrate Cluster from another platform to VKS](https://docs.vngcloud.vn/vng-cloud-document/vn/vks/migration/migrate-cluster-from-other-to-vks)
