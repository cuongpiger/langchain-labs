...
Tài liệu tham khảo [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/vks/network/cni)
...
Tài liệu tham khảo [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/vdns)
...
Tài liệu tham khảo [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/global-load-balancer)
...
Tài liệu tham khảo [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/vdb/kafka-cluster-kds)

**Cross connect**

Đây là dịch vụ hỗ trợ private connect giữa 2 region HN và HCM.

Tài liệu tham khảo [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/vnetwork/cross-connect)
{% endtab %}
{% endtabs %}
...
Tài liệu tham khảo [khoi-tao-mot-private-cluster.md](https://docs.vngcloud.vn/vng-cloud-document/vn/vks/bat-dau-voi-vks/khoi-tao-mot-private-cluster.md "mention")
...
Tài liệu tham khảo [auto-scaling.md](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/vlb-load-balancer-new-version/auto-scaling.md "mention")
...
Tài liệu tham khảo [Endpoint](https://docs.vngcloud.vn/vng-cloud-document/vn/vnetwork/endpoint)
{% endtab %}
...
Tài liệu tham khảo [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/backup-center)
...
Tài liệu tham khảo [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/vnetwork/public-nat-instance)
{% endtab %}
...
Tài liệu hướng dẫn sử dụng [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/vstorage/filestorage)
...
Tài liệu hướng dẫn sử dụng [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/vcloudstack)
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| **Tính năng** | **Nâng cấp mới** | **Ngày phát hành** | **Regions** | **Tài liệu tham khảo** |
| Bandwidths | - Nâng cấp giao diện trên portal chính của vServer tại đây (Portal mới) <br> - Thêm 2 lựa chọn gói BW Dedicated với tốc độ cao, bao gồm Dedicated-TN-5000Mbps và Dedicated-TN-10000Mbps. <br> - Hỗ trợ cho người dùng trả trước: tính năng hỗ trợ POC đối với các gói bán BW Dedicated và cho phép mua các gói BW Pay as you go (PAYG) ngay trên Portal <br> - Các nâng cấp khác: Khách hàng có thể dễ dàng thay đổi gói Bandwidth hoặc nâng cấp/hạ cấp dung lượng sử dụng trên Portal và có thể dễ dàng thêm IP mới vào gói bandwidth phù hợp khi nhu cầu sử dụng tăng cao mà không cần phải thay đổi cấu hình hệ thống phức tạp. | 07/06/2024 | HCM-03 | [Bandwidth](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/network/bandwidth-hcm-03) |
| Search Servers | Cập nhật tính năng Search tìm Servers với các tiêu chí như : Private IP, Public IP, Subnet ID, VPC ID. | 05/2024 | HCM-03 | [Server](https://docs.vngcloud.vn/vng-cloud-document/v/vn/vserver/compute-hcm03-1a/trai-nghiem-san-pham-vserver) |
| Volume | Cập nhật tính năng hỗ trợ đổi tên Volume đã tạo. | 05/2024 | HCM-03 | [Volume](https://docs.vngcloud.vn/vng-cloud-document/v/vn/vserver/compute-hcm03-1a/volume) |
| vLB | Cập nhật chứng chỉ SNI trực tiếp trên Listerner để duy trì và nâng cao bảo mật, đảm bảo các kết nối đến các dịch vụ của bạn luôn an toàn và đáng tin cậy | 05/2024 | HCM-03 | [LoadBalancer](https://docs.vngcloud.vn/vng-cloud-document/v/vn/vserver/compute-hcm03-1a/vlb-load-balancer-new-version) |
| Tags trong Network Interface | Nâng cấp hỗ trợ gắn Tags vào Network Interface khi người dùng tạo một External Interface mới. | 05/2024 | HCM-03 | [External Interface](https://docs.vngcloud.vn/vng-cloud-document/v/vn/vserver/compute-hcm03-1a/network/external-interface) |
| Network Interface | Cập nhật trải nghiệm thanh toán trên External Interface. | 02/05/2024 | HCM-03 | [External Interface](https://docs.vngcloud.vn/vng-cloud-document/v/vn/vserver/compute-hcm03-1a/network/external-interface) |
| Image | Cập nhật trải nghiệm thanh toán trên Image; Khi người dùng tạo Image thì không cần thánh toán (vì chưa xác định được dung lượng) nên hệ thống cho phép sử dụng ba ngày, sau ba ngày thì phải gia hạn để được sử dụng tiếp. | 02/05/2024 | HCM-03 | [Image](https://docs.vngcloud.vn/vng-cloud-document/v/vn/vserver/compute-hcm03-1a/image) |
| SSO - IAM | Cập nhật phương thức đăng nhập mới bằng SSO thông qua tài khoản Google. | 10/04/2024 | HCM-03 | [IAM](https://docs.vngcloud.vn/vng-cloud-document/v/vn/identity-and-access-management-iam/cac-loai-dinh-danh-iam/tai-khoan-user-accounts/cach-dang-nhap-vao-vng-cloud) |
| Snapshot | Nâng cấp cho phép bạn có thể tạo VM hoặc Volume với các bản Snapshot đã sẵn có từ bước tạo VM hoặc tại danh sách Snapshot. | 03/04/2024 | HCM-03 | [Snapshot](https://docs.vngcloud.vn/vng-cloud-document/v/vn/vserver/compute-hcm03-1a/snapshot) |
| Share Snapshot | Nâng cấp tính năng cho Snapshot có thể share những bản Snapshot đến những tài khoản đang sử dụng dịch vụ VNG Cloud. | 03/04/2024 | HCM-03 | [Chia sẻ Snapshot](https://docs.vngcloud.vn/vng-cloud-document/v/vn/vserver/compute-hcm03-1a/snapshot/chia-se-snapshot) |
| Container Lifecycle (vStorage) | Trước đây, Lifecycle cho phép bạn thiết lập việc di chuyển Object từ Storage Class Gold qua Storage Class Silver. Từ nay, chúng tôi sẽ hỗ trợ bạn thiết lập các di chuyển Object từ Storage Class Gold qua Storage Class Archive. Với sự hỗ trợ này, bạn sẽ có thể chủ động thiết lập một hoặc nhiều lifecycle rule di chuyển object nếu trong vòng N ngày mà object không được truy cập. Từ đó giúp bạn tối ưu chi phí lưu trữ theo từng loại dữ liệu khác nhau. | 13/06/2024 | HCM-03 | [Sử dụng tính năng container lifecycle](https://docs.vngcloud.vn/vng-cloud-document/v/vn/vstorage/vstorage-hcm03/cac-tinh-nang-cua-vstorage/lam-viec-voi-container/su-dung-tinh-nang-container-lifecycle) |
| VKS-Persistent Volume Claim Size | **Nâng cấp tính năng thiết lập kích cỡ PVC (Persistent Volume Claim Size):**  Người dùng giờ đây có thể chỉ định kích cỡ tối thiểu cho ổ đĩa CSI là  **1GB**  thay vì kích cỡ tối thiểu là 20GB như trước đây. | 19/6/2024 | HCM-03 | [Volume](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/volume) , [Integrate with Container Storage Interface](https://docs.vngcloud.vn/vng-cloud-document/vn/vks/bat-dau-voi-vks/integrate-with-container-storage-interface-csi) |
| vDB Memory | Ra mắt giao diện Portal mới, đồng bộ với các dịch vụ đang có trên VNG Cloud, giúp mang lại trải nghiệm thân thiện hơn khi sử dụng các dịch vụ trên VNG Cloud. Đồng thời, portal mới của vDB Memory được tích hợp thêm tính năng IAM (Quản lý danh tính và truy cập), giúp khách hàng thuận tiện hơn trong việc quản lý và phân quyền truy cập. Truy cập trải nghiệm tại Portal mới tại đây:  [https://vdb.console.vngcloud.vn/memorystore/database](https://vdb.console.vngcloud.vn/memorystore/database)) | 9/7/2024 | HCM-03 |  |
{% endtab %}
...
|  |  |
| --- | --- |
| **Lợi ích sử dụng** | **Mô tả lợi ích** |
| Thêm lựa chọn Region HAN-01 khi khởi tạo dịch vụ Tăng hiệu suất truy cập cho các Khách hàng ở khu vực Hà Nội | - Các điểm nổi bật chính: <br> - Phù hợp cho KH có dữ liệu/lưu lượng truy cập chính tại Hà Nội hoặc các khu vực lân cận:  giúp tăng hiệu suất truy cập và vận hành dịch vụ <br> - Interconnect up to 10Gbps từ HN đến HCM (CrossRegionConnect): cung cấp giải pháp kết nối riêng tư Interconnect, hỗ trợ KH khi có nhu cầu kết nối 2 Region với nhau. <br> - Encryption dữ liệu tại Blockstorage: Dịch vụ Block Storage cung cấp tính năng mã hóa ổ cứng (Data Encryption) bằng cách sử dụng các khóa dựa trên thuật toán AES-128, AES-256 tiêu chuẩn. Dữ liệu được mã hóa tự động khi nó được truyền từ server đến các ổ cứng và dữ liệu mã hóa sẽ tự động được giải mã khi nó được đọc. |
| - Tính sẵn sàng cao và khả năng phục hồi sau sự cố nhanh <br> - Cần tuân thủ các quy định yêu cầu dữ liệu tại doanh nghiệp – khi đó dữ liệu phải được lưu trữ/sao lưu ở nhiều vị trí (Region) khác nhau. <br> Thiết lập giải pháp Multi Region (coming soon): Hỗ trợ Giải pháp DR cho doanh nghiệp   Giải pháp này sẽ phù hợp với KH cần: | - Các điểm nổi bật chính: <br> - Việc thiết lập Multi-Region giúp KH xây dựng giải pháp DR (Disaster recovery) ở chế độ Warm standby, được sử dụng nhằm đẩy nhanh tốc độ phục hồi dữ liệu sang một Region khác. <br> - VNG Cloud cũng là local cloud đầu tiên trong việc đầu tư phát triển giải pháp này, hỗ trợ KH trong việc xây dựng chiến lược DR và nhanh chóng ứng biến khi có thảm họa xảy ra. <br> - Cross-region backup: dữ liệu chính và bản sao lưu được lưu trữ ở các khu vực riêng biệt về mặt địa lý, giúp tăng khả năng phục hồi khi có sự cố  (bao gồm sự cố thiên tai hoặc lỗi phần mềm hoặc lỗi phần cứng). <br> - Cross-region load balancer: khách hàng có thể thiết lập khả cân bằng tải theo khu vực, với tính sẵn sàng cao và độ trễ thấp cho các ứng dụng cuối của họ. Theo đó, cross-region load balancer cung cấp: <br> - Thiết lập đường Interconnect up to 10Gbps private (CrossRegionConnect):  giúp kết nối 2 region HCM-03 và HAN-01 qua đường Private, giúp tăng cường hiệu suất truy cập và bảo mật kết nối <br> Với việc thiết lập Multi Region, khách hàng có thể thiết lập: + Độ trễ thấp với thuật toán định tuyến dựa trên vị trí địa lý: lưu lượng truy cập của Load Balancer sẽ được định tuyến đến khu vực triển khai gần nhất. + Tự động chuyển đổi dự phòng để khắc phục thảm họa: Khi máy chủ tại Region gặp sự cố, lưu lượng truy cập của khách hàng cuối sẽ được định tuyến lại đến máy chủ Region khác để đảm bảo lưu lượng truy cập liền mạch, không gián đoạn. |
{% endtab %}
...
Tài liệu tham khảo [Bandwidths](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/network/bandwidth-hcm-03/dich-vu-datatransfers-bandwidth)
{% endtab %}
{% endtabs %}
...
Tài liệu hướng dẫn chi tiết [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/datasync)
...
Tài liệu hướng dẫn chi tiết [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/vstorage/filestorage)
...
Tài liệu tham khảo  [Network ACL](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/network/network-acl)
...
| Chi phí | Miễn phí | Giá chỉ từ 500,000vnđ |
| Dung lượng | Thời gian lưu trữ (Retention):1 ngày Metric: 5 resource Log: 10GB/ngày | **Metric:**  Khách hàng lựa chọn gói resource từ 5 đến cao nhất đến 500 resource (với các lựa chọn theo bước nhảy 5). Thời gian lưu trữ Metric 60 ngày. **Log (theo ngày):**  Khách hàng lựa chọn từ 10GB/ngày đến 5TB/ngày (bước nhảy 5GB hoặc 10GB). Thời gian lưu trữ Log (Retention): 3,7,14,30,45,60,90 ngày |
| Gói thông báo qua SMS/Email | Hệ thống có cung cấp lựa chọn miễn phí gói 20 email/SMM mỗi tháng. Khách hàng có thể chủ động lựa chọn gói miễn phí hoặc mua gói tính phí email/SMS với số lượng tùy theo nhu cầu. | Hệ thống có cung cấp lựa chọn miễn phí gói 20 email/SMM mỗi tháng. Khách hàng có thể chủ động lựa chọn gói miễn phí hoặc mua gói tính phí email/SMS với số lượng tùy theo nhu cầu. |
{% endtab %}
{% endtabs %}
