...
### **Bước 2: Chọn giải pháp và lập kế hoạch chiến lược IAM phù hợp** 
...
### **Bước 3: Tạo tài khoản người dùng (User account) trên hệ thống IAM** 
...
### **Bước 4: Thiết lập nhóm người dùng (Group)** 
...
### **Bước 5: Xác định chính sách truy cập (Policies)** 
...
Để xem thông tin chi tiết và ý nghĩa của hành động (Action), tài nguyên (Resource), và điều kiện cần (Request conditions) nhằm thiết lập bộ chính sách truy cập (Policies) hoàn chỉnh, vui lòng xem nội dung tại [trang cấu hình Policies](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/quan-ly-dinh-danh-va-truy-cap-iam-cho-vserver/cac-hanh-dong-tai-nguyen-va-dieu-kien-can-cho-phan-quyen-truy-cap-vserver)

***

### **Bước 5.1: Tạo Service account (Cho việc sử dụng Terraform)** 
...
### **Bước 6: Gán chính sách (Policy) vào User account / Group/ Service account** 
...
### **Bước 8: Thường xuyên xem xét và kiểm tra quyền truy cập** 
