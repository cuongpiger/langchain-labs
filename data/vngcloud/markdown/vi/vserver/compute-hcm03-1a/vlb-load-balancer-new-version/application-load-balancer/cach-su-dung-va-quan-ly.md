...
* Để bắt đầu sử dụng Application Load Balancer, bạn cần có ít nhất **một Virtal Private Cloud (VPC)**, tham khảo hướng dẫn [Virtual Private Cloud (VPC)](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/network/virtual-private-cloud-vpc).
...
* Đối với Application Load Balancer, yêu cầu có ít nhất một chứng chỉ TLS/SSL khi **cấu hình HTTPS Listener**, tham khảo hướng dẫn [Upload a certificate](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/vlb-load-balancer-new-version/application-load-balancer/certificate/upload-a-certificate). 
