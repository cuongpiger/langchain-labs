...
Để tạo Notification với kênh gửi/ nhận là Email, hãy làm theo hướng dẫn bên dưới:
...
5. Chọn **Notification type** là **Email**.
...
![Image](https://github.com/vngcloud/docs/blob/main/Vietnamese/.gitbook/assets/image%20(101).png?raw=true)
